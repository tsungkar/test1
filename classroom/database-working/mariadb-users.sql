...
insert into manufacturer(name,seller,phone_number) values ('SanDisk', 'John Miller','+1 (941) 329-8855');
insert into manufacturer(name,seller,phone_number) values ('Kingston', 'Mike Taylor','+1 (341) 375-9999');
insert into manufacturer(name,seller,phone_number) values ('Asus', 'Wilson Jackson','+1 (432) 367-8899');
insert into manufacturer(name,seller,phone_number) values ('Lenovo', 'Allen Scott','+1 (876) 213-4439');
